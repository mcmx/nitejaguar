...
type AuditLog struct {
	...
	// e.g. enrollment.use, enrollment.create, enrollment.revoke, client.revoke
	Action string `json:"action,omitempty"`
	// TenantID holds the value of the "tenant_id" field.
	TenantID string `json:"tenant_id,omitempty"`
	// who performed the action (client id, token id, or system)
...
func (*AuditLog) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case auditlog.FieldID, auditlog.FieldAction, auditlog.FieldTenantID, auditlog.FieldActor, auditlog.FieldTarget, auditlog.FieldDetail:
